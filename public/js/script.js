const answers_no = {
    english: [
        ...
        "Итгэлтэй байна уу?",
        "Үнэнээсээ юу??",
        "Үнэхээрийн үгүй гэж үү???",
        "Ахин бодох уу?",
        "Ахиад нэг бодох уу?",
        "Why ийм so cold?",
        "Бид ярилцаж болох юм?",
        "Би ахин асуухгүй шүү!",
        "Энэ үйлдэл чинь намайг өвтгөж байна!",
        "Yo are so mean!",
        "Надад бүү ингэж хандаач?",
        "Ахин нэг боломж олгоё!",
        "Би чин сэтгэлээсээ гуйж байна!",
        "За за эхнээс нь эхэлье.."
    ],
    french: [
        "Non",
        "Tu es sûr ?",
